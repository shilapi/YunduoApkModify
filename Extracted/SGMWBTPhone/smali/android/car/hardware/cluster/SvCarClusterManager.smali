...
.method public requestClusterOperation(II)I
    ...
    const-string v0, "requestClusterOperation op:"

    .line 115
    iget-object v1, p0, Landroid/car/hardware/cluster/SvCarClusterManager;->mLock:Ljava/lang/Object;

    monitor-enter v1

    .line 117
    :try_start_0
    iget-object v2, p0, Landroid/car/hardware/cluster/SvCarClusterManager;->mService:Landroid/car/hardware/cluster/ISvCarClusterService;

    invoke-interface {v2, p1, p2}, Landroid/car/hardware/cluster/ISvCarClusterService;->requestClusterOperation(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public unregisterClusterCallback(Landroid/car/hardware/cluster/SvCarClusterManager$ClusterCallback;)I
    ...
    const-string v0, "unregisterCallback, callback: "
    ...
    .line 94
    iget-object v0, p0, Landroid/car/hardware/cluster/SvCarClusterManager;->mCallbacks:Ljava/util/Set;
