.class public Lcom/nforetek/util/db/DbHelperMapCache;
.super Landroid/database/sqlite/SQLiteOpenHelper;
.source "DbHelperMapCache.java"


# static fields
.field private static final DATABASE_NAME:Ljava/lang/String; = "db_map_cache"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v2, "db_map_cache"

    .line 41
    invoke-direct {p0, p1, v2, v0, v1}, Landroid/database/sqlite/SQLiteOpenHelper;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V

    const-string v0, "DbHelperMapCache"

    .line 19
    iput-object v0, p0, Lcom/nforetek/util/db/DbHelperMapCache;->TAG:Ljava/lang/String;

    const-string v1, "_id"

    .line 26
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->_id:Ljava/lang/String;

    const-string v1, "handle"

    .line 27
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->handle:Ljava/lang/String;

    const-string v1, "subject"

    .line 28
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->subject:Ljava/lang/String;

    const-string v1, "message"

    .line 29
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->message:Ljava/lang/String;

    const-string v1, "datetime"

    .line 30
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->datetime:Ljava/lang/String;

    const-string v1, "sender_name"

    .line 31
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->sender_name:Ljava/lang/String;

    const-string v1, "sender_addressing"

    .line 32
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->sender_addressing:Ljava/lang/String;

    const-string v1, "recipient_addressing"

    .line 33
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->recipient_addressing:Ljava/lang/String;

    const-string v1, "size"

    .line 34
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->size:Ljava/lang/String;

    const-string v1, "read"

    .line 35
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->read:Ljava/lang/String;

    const-string v1, "macAddress"

    .line 36
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->macAddress:Ljava/lang/String;

    const-string v1, "folder"

    .line 37
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->folder:Ljava/lang/String;

    const-string v1, "select * from MessageContent where condition = ?"

    .line 265
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_MESSAGE:Ljava/lang/String;

    const-string v1, "select * from MessageContent where macAddress = ?"

    .line 267
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_SELECT_MESSAGE:Ljava/lang/String;

    const-string v1, "select * from MessageContent where macAddress = ? and handle = ? and folder = ?"

    .line 270
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_SELECT_ONE_MESSAGE:Ljava/lang/String;

    const-string v1, "select * from MessageContent where folder = ? and handle = ? and macAddress = ?"

    .line 273
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_SELECT_MESSGE_BY_FOLDER_AND_HANDLE:Ljava/lang/String;

    const-string v1, "delete from MessageContent where macAddress = ?"

    .line 276
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_DELETE_MESSAGE:Ljava/lang/String;

    const-string v1, "delete from MessageContent where macAddress = ? and folder = ?"

    .line 280
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_DELETE_FOLDER:Ljava/lang/String;

    const-string v1, "delete from MessageContent where macAddress = ? and handle = ? and datetime=?"

    .line 283
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_DELETE_ONE_MESSAGE:Ljava/lang/String;

    const-string v1, "delete from MessageContent"

    .line 286
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_DELETE_All_MESSAGE:Ljava/lang/String;

    const-string v1, "delete from MessageContent where folder = ? and handle = ? and macAddress = ?"

    .line 289
    iput-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->SQL_DELETE_MESSAGE_BY_FOLDER:Ljava/lang/String;
    ...
    .line 43
    iput-object p1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->m_context:Landroid/content/Context;
...
.method public deleteMessageByFolderAndHandle(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
...
.method public insertMessageInfo(Landroid/database/sqlite/SQLiteDatabase;Lcom/nforetek/bt/res/MsgOutline;)V
    ...
    .line 95
    iget-object v0, p0, Lcom/nforetek/util/db/DbHelperMapCache;->TAG:Ljava/lang/String;
    ...
    .line 99
    iget-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->TAG:Ljava/lang/String;
...
.method public isMessageInDatabase(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 217
    iget-object p1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->TAG:Ljava/lang/String;
    ...
    .line 221
    iget-object p3, p0, Lcom/nforetek/util/db/DbHelperMapCache;->TAG:Ljava/lang/String;
    ...
    .line 226
    iget-object v3, p0, Lcom/nforetek/util/db/DbHelperMapCache;->TAG:Ljava/lang/String;
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 53
    iget-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->_id:Ljava/lang/String;
    ...
    .line 54
    iget-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->folder:Ljava/lang/String;
    ...
    .line 55
    iget-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->handle:Ljava/lang/String;
    ...
    .line 56
    iget-object v2, p0, Lcom/nforetek/util/db/DbHelperMapCache;->subject:Ljava/lang/String;
    ...
    .line 57
    iget-object v2, p0, Lcom/nforetek/util/db/DbHelperMapCache;->message:Ljava/lang/String;
    ...
    .line 58
    iget-object v2, p0, Lcom/nforetek/util/db/DbHelperMapCache;->datetime:Ljava/lang/String;
    ...
    .line 59
    iget-object v2, p0, Lcom/nforetek/util/db/DbHelperMapCache;->sender_name:Ljava/lang/String;
    ...
    .line 60
    iget-object v2, p0, Lcom/nforetek/util/db/DbHelperMapCache;->sender_addressing:Ljava/lang/String;
    ...
    .line 61
    iget-object v2, p0, Lcom/nforetek/util/db/DbHelperMapCache;->recipient_addressing:Ljava/lang/String;
    ...
    .line 62
    iget-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->read:Ljava/lang/String;
    ...
    .line 63
    iget-object v1, p0, Lcom/nforetek/util/db/DbHelperMapCache;->macAddress:Ljava/lang/String;
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 160
    invoke-virtual {p0, p1}, Lcom/nforetek/util/db/DbHelperMapCache;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
