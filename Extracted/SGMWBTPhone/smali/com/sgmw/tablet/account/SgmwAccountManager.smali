...
.method private getAuthCode(Ljava/util/HashMap;)V
    ...
    const-string v1, "getAuthCode:result="
    ...
    sget-boolean v7, Lcom/sgmw/tablet/account/SgmwAccountManager;->sDebugAPI:Z

    if-eqz v7, :cond_0

    sget-object v7, Lcom/sgmw/tablet/account/SgmwAccountManager;->BASE_URL_DESAYSV_TEST:Ljava/lang/String;

    goto :goto_0

    :cond_0
    sget-object v7, Lcom/sgmw/tablet/account/SgmwAccountManager;->BASE_URL_DESAYSV_NORMAL:Ljava/lang/String;
    ...
    const-string v7, "v2/oauth2/authorizationCode?state="
    ...
    .line 613
    sget-object v3, Lcom/sgmw/tablet/account/SgmwAccountManager;->TAG:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    const-string v5, "getAuthCode:path="
    ...
    invoke-static {v3, v4}, Lcom/sgmw/tablet/account/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 619
    sget-boolean v4, Lcom/sgmw/tablet/account/SgmwAccountManager;->sDebugAPI:Z

    if-eqz v4, :cond_1

    sget-object v4, Lcom/sgmw/tablet/account/SgmwAccountManager;->DESAYSV_TEST_API_KEY:Ljava/lang/String;

    goto :goto_1

    :cond_1
    sget-object v4, Lcom/sgmw/tablet/account/SgmwAccountManager;->DESAYSV_NORMAL_API_KEY:Ljava/lang/String;
    ...
    .line 622
    sget-object v4, Lcom/sgmw/tablet/account/SgmwAccountManager;->TAG:Ljava/lang/String;
    ...
    invoke-static {v4, v2}, Lcom/sgmw/tablet/account/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v1}, Lcom/sgmw/tablet/account/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method private declared-synchronized getUserInfo()Lcom/sgmw/tablet/account/User;
    ...
    const-string v0, "getUserInfo, error: "
    ...
    const-string v1, "getUserInfo():  mContext is null!"
    ...
    sget-object v4, Lcom/sgmw/tablet/account/SgmwAccountManager;->URI_USER:Landroid/net/Uri;
    ...
    invoke-static {v3, v0, v1}, Lcom/sgmw/tablet/account/LogUtil;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method private notifyChange()V
    ...
    const-string/jumbo v5, "\u5df2\u767b\u5f55"

    const-string/jumbo v6, "\u672a\u767b\u5f55"
    ...
    const-string/jumbo v5, "\u5df2\u767b\u5f55,\u8fd8\u672a\u67e5\u8be2\u7ed1\u5b9a\u72b6\u6001\uff1a"
    ...
    const-string/jumbo v0, "\u5df2\u767b\u5f55,\u8fd8\u672a\u67e5\u8be2\u7ed1\u5b9a\u72b6\u6001"
...
.method private sendMsgToService()V
    ...
    const-string/jumbo v1, "\u89e3\u7ed1\u6d88\u606f\u53d1\u9001\u5f02\u5e38"
...
.method public queryAcctToken()V
    ...
    .line 282
    iget-object v3, v0, Lcom/sgmw/tablet/account/BindStatusEnum;->packageName:Ljava/lang/String;
...
.method public updateBondState(Lcom/sgmw/tablet/account/BindStatusEnum;)V
    ...
    .line 463
    iget-object v2, p1, Lcom/sgmw/tablet/account/BindStatusEnum;->packageName:Ljava/lang/String;
