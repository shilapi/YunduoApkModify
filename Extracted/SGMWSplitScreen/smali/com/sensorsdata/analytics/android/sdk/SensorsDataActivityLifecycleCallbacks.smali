...
.method private trackAppEnd(JLjava/lang/String;)V
    ...
    .line 335
    :try_start_0
    iget-object v7, v1, Lcom/sensorsdata/analytics/android/sdk/SensorsDataActivityLifecycleCallbacks;->mSensorsDataInstance:Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;

    invoke-virtual {v7}, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;->isAutoTrackEnabled()Z
    ...
    .line 339
    iget-object v8, v1, Lcom/sensorsdata/analytics/android/sdk/SensorsDataActivityLifecycleCallbacks;->mDbAdapter:Lcom/sensorsdata/analytics/android/sdk/data/DbAdapter;

    invoke-virtual {v8}, Lcom/sensorsdata/analytics/android/sdk/data/DbAdapter;->getAppStartTime()J
    ...
    .line 341
    new-instance v8, Lcom/sensorsdata/analytics/android/sdk/EventTimer;
    ...
    invoke-direct/range {v9 .. v14}, Lcom/sensorsdata/analytics/android/sdk/EventTimer;-><init>(Ljava/util/concurrent/TimeUnit;JJ)V

    const-string v9, "SA.LifecycleCallbacks"
    ...
    invoke-virtual {v8}, Lcom/sensorsdata/analytics/android/sdk/EventTimer;->duration()Ljava/lang/String;
    ...
    invoke-static {v9, v2}, Lcom/sensorsdata/analytics/android/sdk/SALog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v5, v8}, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;->trackTimer(Ljava/lang/String;Lcom/sensorsdata/analytics/android/sdk/EventTimer;)V
